classdef ImageWaitForModify1
    ...
    methods
        function obj=ImageWaitForModify1(mfilename)
...
%                 imshow(obj.raw/255/255);
            ...
            obj.nl_srgb=camtexinghua1(obj.lin_rgb)/255;     
...
%                     keyboard.uv=keyboard.uv+obj.lab_modifier;
                    ...
                    global XYZright XYZleft XYZright1 XYZleft1
                    % 对半边图像应用色彩矩阵
...
%                     m=strcat('1221uv31.txt');
                    m=strcat(folderPath,'\uvREPEAT.txt');
                    fid=fopen(m,'a');
...
%                     fprintf(fid,'\n'); 
                    ...
                    mfilename='X2D_ratio31_cct6500_6500_0ev';
                    hj_init_keyboard
                    global image 
                    image=ImageWaitForModify1(mfilename)
                    h=mTestFig
                    sound(sin(2*pi*25*(1:4000)/100));
                    pause(60)
                    sound(sin(2*pi*25*(1:4000)/100));
