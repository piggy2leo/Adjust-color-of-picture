classdef ImageWaitForModify
    ...
    methods
        function obj=ImageWaitForModify(mfilename)
...
%                 imshow(obj.raw/255/255);
            ...
            global XYZtotal XYZleft XYZright
            obj.XYZ1=XYZtotal;
            obj.XYZleft=XYZleft;
            obj.XYZright=XYZright;
%             cali=load('CalibrationPars_T1_15-Jan-2025.txt');
...
%                     keyboard.uv=keyboard.uv+obj.lab_modifier;
                    ...
                    % 对半边图像应用色彩矩阵
                    global XYZleft XYZright XYZleft1 XYZright1
                    XYZleft1= apply_cmatrix(obj.XYZleft,obj.Mcat);
                    F=XYZleft1+XYZright1;
                    XYZf = reshape(F, [], 3)*2.5;
                    nl_srgb= xyz2ScreenRgb_PCA(XYZf, load('CalibrationPars_T1_15-Jan-2025.txt'));
                    global s3 s4
...
%                     keyboard.uv=keyboard.uv+obj.lab_modifier;
                    ...
                    global XYZright XYZleft XYZleft1 XYZright1
                    % 对半边图像应用色彩矩阵
                    XYZright1= apply_cmatrix(obj.XYZright,obj.Mcat);
                    F=XYZright1+XYZleft1;
...
%                     m=strcat('1221uv11.txt');
                    m=strcat(folderPath,'\uv11.txt');
                    fid=fopen(m,'a');
...
%                     fprintf(fid,'\n'); 
                    ...
                    mfilename='X2D_ratio11_cct6500_6500_0ev';
                    hj_init_keyboard
                    global image 
                    image=ImageWaitForModify(mfilename)
                    h=mTestFig
                    sound(sin(2*pi*25*(1:4000)/100));
                    pause(5)
                    sound(sin(2*pi*25*(1:4000)/100));
